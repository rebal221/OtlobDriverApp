...
class OrderDetailsMulti extends StatefulWidget {
  const OrderDetailsMulti({Key? key}) : super(key: key);

  @override
  State<OrderDetailsMulti> createState() => _OrderDetailsMultiState();
}

class _OrderDetailsMultiState extends State<OrderDetailsMulti> {
                ...
                ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                          ...
                          child: ContainerOrderDetailsMulti(
