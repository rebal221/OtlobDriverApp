...
import '../../../widget/map_details_customer.dart';
...
class OrderCustomerDetails extends StatefulWidget {
  // const OrderDetailsAccept({Key? key}) : super(key: key);
  bool isDone = false;

  OrderCustomerDetails({ this.isDone= false});

  @override
  State<OrderCustomerDetails> createState() => _OrderCustomerDetailsState();
}

class _OrderCustomerDetailsState extends State<OrderCustomerDetails> {
